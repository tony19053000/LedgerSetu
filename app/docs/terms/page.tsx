  ...
  return (
    <div className="prose prose-slate max-w-none">
      ...
      <p className="bg-slate-50 p-4 rounded-lg border border-slate-200 mb-6">
        ...
        <a href="https://ledgersetu.local" className="text-blue-600 hover:text-blue-800">
          https://ledgersetu.local
        </a>
        <br />
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        These Terms of Service (&quot;Terms&quot;) govern your access to and use of LedgerSetu, an automated invoice
      ...
      <p className="text-slate-700 mb-3">LedgerSetu offers:</p>
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>
          A <strong className="text-slate-800">self-hosted platform</strong> available for individuals and teams
        </li>
      </ul>
      <p className="text-slate-700 mb-6 leading-relaxed">
        Users can upload invoices and receipts, analyze transactions, and manage expenses via AI-powered tools. The
        service is primarily designed for Indian freelancers and businesses.
      </p>

      <h2 className="text-2xl font-semibold text-slate-800 mb-4">2. Eligibility and Account Use</h2>
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>
          You must be at least <strong className="text-slate-800">18 years old</strong> to use LedgerSetu.
        </li>
        <li>
      ...
      <h2 className="text-2xl font-semibold text-slate-800 mb-4">3. Availability</h2>
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>
          LedgerSetu is provided as a self-hosted platform. Users are responsible for their own hosting, data security,
          and any third-party API costs.
        </li>
      </ul>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>
          LedgerSetu uses <strong className="text-slate-800">OpenAI (ChatGPT)</strong> and other third-party APIs to
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        ...
        <li>
          LedgerSetu does <strong className="text-slate-800">not claim any rights</strong> over your data.
        </li>
        <li>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>
          LedgerSetu is provided <strong className="text-slate-800">&quot;as is&quot;</strong>, without warranties of any
          kind.
        </li>
        <li>
        ...
        <li className="bg-yellow-50 p-3 border-l-4 border-yellow-400">
          <strong className="text-slate-800">⚠️ Important:</strong> LedgerSetu is{" "}
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        These Terms are governed by the laws of <strong className="text-slate-800">India</strong>.<br />
        Any disputes shall be resolved exclusively in the courts located in{" "}
        <strong className="text-slate-800">India</strong>, unless otherwise required by applicable law.
      </p>
