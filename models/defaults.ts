...
export const DEFAULT_PROMPT_ANALYSE_NEW_FILE = `You are an accountant and invoice analysis assistant for an Indian business. Extract the following information from the given invoice, paying special attention to GST and Indian tax guidelines: 
...
export const DEFAULT_FIELDS = [
  ...
  },
  {
    ...
    name: "GST/Tax Rate",
    type: "number",
    llm_prompt: "GST or Tax rate in percentage 0-100",
    isVisibleInList: false,
    isVisibleInAnalysis: false,
    isRequired: false,
    isExtra: true,
  ...
  {
    code: "tax_amount",
    name: "Total Tax/GST Amount",
    type: "number",
    llm_prompt: "Total tax amount (GST) in currency of the invoice",
    isVisibleInList: false,
    isVisibleInAnalysis: false,
    isRequired: false,
    isExtra: true,
  },
  {
    ...
    name: "Merchant GSTIN",
    type: "string",
    llm_prompt: "GSTIN (Goods and Services Tax Identification Number) of the merchant",
    isVisibleInList: false,
    isVisibleInAnalysis: false,
    isRequired: false,
    isExtra: true,
  },
  {
    ...
    name: "CGST Amount",
    type: "number",
    llm_prompt: "CGST (Central GST) amount if specified",
    isVisibleInList: false,
    isVisibleInAnalysis: false,
    isRequired: false,
    isExtra: true,
  },
  {
    ...
    name: "SGST Amount",
    type: "number",
    llm_prompt: "SGST (State GST) amount if specified",
    isVisibleInList: false,
    isVisibleInAnalysis: false,
    isRequired: false,
    isExtra: true,
  },
  {
    ...
    name: "IGST Amount",
    type: "number",
    llm_prompt: "IGST (Integrated GST) amount if specified",
    isVisibleInList: false,
    isVisibleInAnalysis: false,
    isRequired: false,
    isExtra: true,
