  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        <small className="text-muted-foreground">
          This provider's credentials and base model are centrally managed by the server. 
        </small>
        <input type="hidden" name={provider.apiKeyName} value={value.apiKey} />
        <input type="hidden" name={provider.modelName} value={value.model} />
      </div>
      {provider.apiDoc && (
        <small className="text-muted-foreground">
